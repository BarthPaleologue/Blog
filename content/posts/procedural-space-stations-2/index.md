...
{{<figure src="./freefall.gif" alt="Astronaut free falling" caption="Astronaut free falling">}}
...
{{<figure src="./roundabout.gif" alt="simpson roundabout" caption="simpson roundabout">}}
...
{{<figure src="./2001.gif" alt="2001 space station" caption="2001 space station">}}
...
{{<figure src="image.png" alt="O'neel cylinders" caption="O'neel cylinders">}}

And also anything in between like helixes:

{{<figure src="image-1.png" alt="https://www.arup.com/projects/helix-space-station" caption="https://www.arup.com/projects/helix-space-station">}}

or the Citadel from Mass Effect:

{{<figure src="image-2.png" alt="Citadel in Mass Effect" caption="Citadel in Mass Effect">}}
...
{{<figure src="./gradient.gif" alt="Gradient of gravity" caption="Gradient of gravity">}}
...
{{<figure src="https://upload.wikimedia.org/wikipedia/commons/b/b6/Corioliskraftanimation.gif" alt="Coriolis" caption="Coriolis">}}
