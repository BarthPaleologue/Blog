...
{{<figure src="./freefall.gif" alt="Astronaut free falling" caption="Astronaut free falling" caption-position="bottom">}}
...
{{<figure src="./roundabout.gif" alt="simpson roundabout" caption="simpson roundabout" caption-position="bottom">}}
...
{{<figure src="./2001.gif" alt="2001 space station" caption="2001 space station" caption-position="bottom">}}
...
{{<figure src="image.png" alt="O'neel cylinders" caption="O'neel cylinders" caption-position="bottom">}}

And also anything in between like helixes:

{{<figure src="image-1.png" alt="https://www.arup.com/projects/helix-space-station" caption="https://www.arup.com/projects/helix-space-station" caption-position="bottom">}}

or the Citadel from Mass Effect:

{{<figure src="image-2.png" alt="Citadel in Mass Effect" caption="Citadel in Mass Effect" caption-position="bottom">}}
...
{{<figure src="./gradient.gif" alt="Gradient of gravity" caption="Gradient of gravity" caption-position="bottom">}}
...
{{<figure src="https://upload.wikimedia.org/wikipedia/commons/b/b6/Corioliskraftanimation.gif" alt="Coriolis" caption="Coriolis" caption-position="bottom">}}
