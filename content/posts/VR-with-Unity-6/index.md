...
{{<figure src="image.png" alt="One hour later" caption="One hour later" caption-position="bottom">}}
...
{{<figure src="image-4.png" alt="Shelf highlighting" caption="Shelf highlighting" caption-position="bottom">}}
...
{{<figure src="image-5.png" alt="SCARY SANDWICHES" caption="SCARY SANDWICHES" caption-position="bottom">}}
...
{{<figure src="image-6.png" alt="Item bounding box" caption="Item bounding box">}}Item bounding box" caption="Item bounding box" caption-position="bottom">}}

And now we can tell apart the sandwiches!

{{<figure src="image-7.png" alt="The sandwich problem, solved!" caption="The sandwich problem, solved!" caption-position="bottom">}}
...
{{<figure src="image-8.png" alt="xOffset" caption="xOffset" caption-position="bottom">}}
